...
| [0004: Lossless JSON representation](0004-lossless-json-representation.md) | Accepted | Adopt a Concrete Syntax Tree (CST) architecture to retain original bytes and safely manage structural edits. |
