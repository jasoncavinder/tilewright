...
| Project-file parsing | Not implemented | ADR 0004 selects a CST architecture, but no production loader or format models exist. |
| Project validation | Not implemented | No validation contract exists. |
| Lossless round trips | Not implemented | ADR 0004 selects a CST architecture, but no production round-trip guarantee or supported mutation exists. |
