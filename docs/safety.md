...
mutation surface. The first experimental map catalog copies a bounded set of
typed scalar values from the retained CST without changing raw bytes. Production
