...
expose CST nodes or mutate the snapshot. The experimental player-start
validator composes those owned projections without adding filesystem I/O or a
second representation layer.
